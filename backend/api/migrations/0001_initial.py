# Generated by Django 2.1.2 on 2018-10-06 10:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='accounttoquoteset',
            name='quoteset',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.QuoteSet'),
        ),
        migrations.AddField(
            model_name='account',
            name='following_list',
            field=models.ManyToManyField(through='api.AccountToQuoteSet', to='api.QuoteSet'),
        ),
        migrations.AddField(
            model_name='account',
            name='groups',
